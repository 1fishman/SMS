    ...
    <div class="container">
    	...
    	<div class="main">
    		<div class="nav nav-cls2 left">
				<h3></h3>
				<ul>
					<li><a href="admin_student.jsp">学生信息管理</a></li>
					<li><a href="admin_teacher.jsp">教师信息管理</a></li>
					<li><a href="admin_subject.jsp">课程信息管理</a></li>
					<li><a href="admin_grade.jsp">查看成绩信息</a></li>
